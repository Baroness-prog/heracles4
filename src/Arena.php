    ...
    public function battle ($id) : void
    {
        ...
        if ($monster->getLife() <= 0) {
            ...
            if ($this->touchable($monster, $this->getHero())) {
                ...
                throw new Exception('Hero trop éloigné');
            }
        }
    }
}